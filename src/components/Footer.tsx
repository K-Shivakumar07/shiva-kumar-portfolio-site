      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="md:col-span-2">
            <h3 className="text-xl font-bold mb-4">K. Shiva Kumar</h3>
            <p className="text-gray-300 mb-4 max-w-md">
              A passionate CSE student specializing in AI & ML, focused on building innovative software solutions and exploring new technologies.
            </p>
            <p className="text-gray-300">&copy; {currentYear} K. Shiva Kumar. All rights reserved.</p>
          </div>
        ...
        <div className="border-t border-gray-700 mt-8 pt-8 text-center text-gray-400 text-sm">
          <p>Designed and built with ❤️ by K. Shiva Kumar</p>
        </div>
      </div>
    </footer>
  );
